<x-layouts.app title="داشبورد">
    ...
    {{--
        Tile grid — measured pixel-by-pixel against tab_emkanat.png, not
        eyeballed. It is NOT a uniform 6-column grid: each row is 3 clusters
        (two paired tiles + one wide tile) with a small gap inside a pair
        (~9px measured) and a much larger gap between clusters (~66px
