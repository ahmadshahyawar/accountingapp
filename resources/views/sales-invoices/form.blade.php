<x-layouts.app title="فاکتور فروش">
    ...
    <form action="{{ route('sales-invoices.store') }}" method="POST"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
            ...
            <x-ui.field label="مشتری" name="person_id" type="select" required
                :options="['' => '— انتخاب —'] + $customers->pluck('name', 'id')->all()" />
        ...
        <button type="submit" class="px-6 py-2 bg-sky-700 text-white rounded-md text-sm hover:bg-sky-800">ثبت فاکتور</button>
    </form>
</x-layouts.app>
