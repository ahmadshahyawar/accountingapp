<x-layouts.app title="برگشت از خرید">
    <form action="{{ route('purchase-returns.store') }}" method="POST"
        ...
        <div class="grid-toolbar" style="border-top:none;border-bottom:1px solid #d7dce1;padding:8px 2px 12px;margin-bottom:0">
            ...
            <div class="legacy-form-title" style="flex:2;padding:0">فاکتور برگشت از خرید</div>
        ...
        <div style="display:flex;gap:8px;align-items:center;margin-bottom:8px">
            ...
            <div class="f" style="flex:1"><label>نام</label><input type="text" readonly :value="selectedSupplier?.name || ''"></div>
        </div>

        <div class="legacy-infogrid">
            <div class="f"><label>موبایل</label><input type="text" readonly :value="selectedSupplier?.mobile || '—'"></div>
            <div class="f"><label>تلفن</label><input type="text" readonly :value="selectedSupplier?.phone || '—'"></div>
            <div class="f">
        ...
        <div class="grid-toolbar">
            <div class="grp">
                ...
                <a href="{{ route('purchase-returns.index') }}" class="btn3d">
