<x-layouts.app title="پیش فاکتور">
    <form action="{{ route('proforma-invoices.store') }}" method="POST"
        ...
        <div class="grid-toolbar" style="border-top:none;border-bottom:1px solid #d7dce1;padding:8px 2px 12px;margin-bottom:0">
            ...
            <div class="legacy-form-title" style="flex:2;padding:0">پیش فاکتور</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="md:col-span-2 legacy-field" style="margin-bottom:0">
                <label>توضیحات</label>
            ...
            <div class="legacy-field" style="margin-bottom:0">
                ...
                <div class="text-sm font-bold mt-2" x-text="'مجموع کل: ' + grandTotal.toFixed(2)"></div>
            </div>
        </div>
        ...
        <div class="grid-toolbar">
            <div class="grp">
                ...
                <a href="{{ route('proforma-invoices.index') }}" class="btn3d">
