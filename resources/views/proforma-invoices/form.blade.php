<x-layouts.app title="پیش فاکتور">
    <x-ui.page-header title="پیش فاکتور جدید" :back-route="route('proforma-invoices.index')" />
    ...
    <form action="{{ route('proforma-invoices.store') }}" method="POST"
        ...
        <button type="submit" class="px-6 py-2 bg-sky-700 text-white rounded-md text-sm hover:bg-sky-800">ثبت پیش فاکتور</button>
    </form>
</x-layouts.app>
